...
namespace Bread.Models
{
    ...
    public partial class JobCategory : Entity<JobCategory>
    {
        #region 对象操作
        static JobCategory()
        {
        ...
        public static JobCategory FindByID(Int32 id)
        {
            if (id <= 0) return null;
        ...
        // Select Count(ID) as ID,Category From JobCategory Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By ID Desc limit 20
        //static readonly FieldCache<JobCategory> _CategoryCache = new FieldCache<JobCategory>(nameof(Category))
        //{
